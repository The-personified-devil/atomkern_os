...
#[thread_local]
pub static TLD: RefCell<*mut Tld<'static>> = RefCell::new(null_mut());
...
extern "C" {
    pub fn do_syscall(header: u64, meta: u64, addr: u64, rip: u64, page_count: u64);
}
